...
if __name__ == "__main__":
    ...
    parser.add_argument("--few-shot", type=bool, default=False, help="Whether to add an example to the prompt. (default: False)")
    parser.add_argument("--clean-html", type=bool, default=False, help="Whether to clean the HTML before processing (default: False)")
    parser.add_argument("--max-tokens", type=int, default=2048, help="Max tokens for OpenAI model (default: 2048)")
