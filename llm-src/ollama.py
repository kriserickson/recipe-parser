...
def get_ollama_completion(prompt, ollama_model, max_tokens, temperature, top_p, num_ctx):
    options = {
...
def main():
    ...
    parser.add_argument("--max-tokens", type=int, default=1024, help="Max tokens for Ollama response")
...
"""
    ...
    result = get_ollama_completion(prompt, ollama_model=args.model, max_tokens=args.max_tokens,
                                   temperature=args.temperature, top_p=args.top_p, num_ctx=args.num_ctx)
